...
class TestIRISDataTypeRegistry:
    ...
    def test_numeric_type_mappings(self):
        ...
        if self.registry.has_mapping('DOUBLE'):
            ...
            assert 'DOUBLE' in double_mapping.postgresql_type or 'FLOAT8' in double_mapping.postgresql_type
    ...
    def test_vector_type_mapping(self):
        ...
        assert 'VECTOR' in vector_mapping.postgresql_type or 'REAL[]' in vector_mapping.postgresql_type
    ...
    def test_constitutional_compliance(self):
        ...
        assert len(low_confidence_types) <= 8, f"Too many low confidence mappings found: {low_confidence_types}"
    ...
    def test_mapping_performance(self):
        ...
        types_to_test = [
            'INTEGER', 'BIGINT', 'VARCHAR', 'CHAR', 'DATE', 'TIMESTAMP',
            'DECIMAL', 'VARBINARY', 'BLOB', 'CLOB', 'VECTOR'
        ]
    ...
    def test_type_compatibility_rules(self):
        ...
        for type_name in numeric_types:
            if self.registry.has_mapping(type_name):
                ...
                assert any(nt in pg_type for nt in ['INTEGER', 'BIGINT', 'DECIMAL', 'NUMERIC', 'INT', 'FLOAT'])
...
class TestDataTypeRegistryPerformance:
    ...
    def test_type_specification_parsing_performance(self):
        ...
        type_specs = [
            'VARCHAR(255)', 'CHAR(10)', 'DECIMAL(10,2)', 'NUMERIC(15,5)',
            'TIMESTAMP', 'DATE', 'TIME', 'INTEGER', 'BIGINT', 'BLOB'
        ]
