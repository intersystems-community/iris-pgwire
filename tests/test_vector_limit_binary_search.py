...
def binary_search_max_dimension(port: int, path_name: str, min_dim: int = 1024, max_dim: int = 100000):
    ...
    while left <= right:
        ...
        print(f'\n  Iteration {iteration}: Testing {mid:,}D (range: {left:,}-{right:,})', end=' ', flush=True)
