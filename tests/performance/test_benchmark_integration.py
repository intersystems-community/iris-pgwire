...
class TestBenchmarkIntegration:
    ...
    def test_benchmark_runner_with_mock_executor(self):
        ...
        assert all(isinstance(r, PerformanceResult) for r in results), "All results should be PerformanceResult"
        ...
        assert mock_executor.call_count >= 15, f"Expected at least 15 calls, got {mock_executor.call_count}"
